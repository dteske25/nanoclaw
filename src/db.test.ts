...
describe('getMessagesSince', () => {
  beforeEach(() => {
    ...
    const msgs = [
      ...
      { id: 'm3', content: 'nano: bot reply', ts: '2024-01-01T00:00:03.000Z', sender: 'Bot' },
  ...
  it('returns messages after the given timestamp', () => {
    const msgs = getMessagesSince('group@g.us', '2024-01-01T00:00:02.000Z', 'nano');
  ...
  it('excludes messages from the assistant (content prefix)', () => {
    const msgs = getMessagesSince('group@g.us', '2024-01-01T00:00:00.000Z', 'nano');
    const botMsgs = msgs.filter((m) => m.content.startsWith('nano:'));
    expect(botMsgs).toHaveLength(0);
  });

  it('returns all messages when sinceTimestamp is empty', () => {
    const msgs = getMessagesSince('group@g.us', '', 'nano');
...
describe('getNewMessages', () => {
  beforeEach(() => {
    ...
    const msgs = [
      ...
      { id: 'a3', chat: 'group1@g.us', content: 'nano: reply', ts: '2024-01-01T00:00:03.000Z' },
  ...
  it('returns new messages across multiple groups', () => {
    ...
    // Excludes 'nano: reply', returns 3 messages
  ...
  it('returns empty for no registered groups', () => {
    const { messages, newTimestamp } = getNewMessages([], '', 'nano');
